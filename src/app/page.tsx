...
function GardenIllustration() {
  const topLeftPlants = [
    [73, 70], [115, 70], [157, 70],
    [73, 118], [115, 118], [157, 118],
  ];
  const bottomLeftPlants = [
    [75, 236], [115, 236], [155, 236],
    [75, 278], [115, 278], [155, 278],
    [75, 320], [115, 320], [155, 320],
  ];
  const topRightPlants = [
    [323, 70], [365, 70], [407, 70],
    [323, 118], [365, 118], [407, 118],
  ];
  const bottomRightPlants = [
    [325, 236], [365, 236], [405, 236],
    [325, 278], [365, 278], [405, 278],
    [325, 320], [365, 320], [405, 320],
  ];
